...
public class GamesActivity3WithCategoriesSubCats2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gamesList.add(new GameCategory("Четвёртый лишний", R.drawable.g4th_1_3, GamesActivity3_4thExtra.class));
        gamesList.add(new GameCategory("Выбери нужный размер", R.drawable.g_cr_1_1, GamesActivity3_ChooseRight.class));
