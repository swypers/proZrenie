...
public class RepeatImageChooseAdapter extends RecyclerView.Adapter<RepeatImageChooseAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public RepeateImageGameType game_type;
    ...
    @Override
    public RepeatImageChooseAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RepeatImageChooseAdapter.ViewHolder viewHolder = new RepeatImageChooseAdapter.ViewHolder(kidsView);
        return viewHolder;
    }

    // Involves populating data into the item through holder
    @Override
    public void onBindViewHolder(RepeatImageChooseAdapter.ViewHolder holder, int position) {
        // Get the data model based on position
        RepeateImageGameType game_type = mgameActivities.get(position);
    ...
    private List<RepeateImageGameType> mgameActivities;

    // Pass in the contact array into the constructor
    public RepeatImageChooseAdapter(List<RepeateImageGameType> gameActivities) {
