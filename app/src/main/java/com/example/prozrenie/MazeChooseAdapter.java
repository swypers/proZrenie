...
public class MazeChooseAdapter extends RecyclerView.Adapter<MazeChooseAdapter.ViewHolder> {
    ...
    @Override
    public MazeChooseAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MazeChooseAdapter.ViewHolder viewHolder = new MazeChooseAdapter.ViewHolder(kidsView);
        return viewHolder;
    }

    // Involves populating data into the item through holder
    @Override
    public void onBindViewHolder(MazeChooseAdapter.ViewHolder holder, int position) {
    ...
    public MazeChooseAdapter(List<RepeateImageGameType> gameActivities) {
