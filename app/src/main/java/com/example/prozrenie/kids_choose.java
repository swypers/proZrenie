...
public class kids_choose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kid_activities.add(new KidActivity("Игры", R.drawable.kids_game, GameCategoryChooseActivity.class));
        kid_activities.add(new KidActivity("Аудиосказки", R.drawable.music_logo, AudioStoriesActivity.class));
