...
public class RememberAndChooseAdapter extends RecyclerView.Adapter<RememberAndChooseAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public RememberAndRepeatGameType game_type;
            ...
            activity_button.setOnClickListener(new View.OnClickListener() {
                                                   ...
                                                   public void onClick(View view) {
                                                       ...
                                                       Intent intent = new Intent(context,
                                                               RememberAndChooseActivity.class);
    ...
    @Override
    public RememberAndChooseAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RememberAndChooseAdapter.ViewHolder viewHolder = new RememberAndChooseAdapter.ViewHolder(kidsView);
        return viewHolder;
    }

    // Involves populating data into the item through holder
    @Override
    public void onBindViewHolder(RememberAndChooseAdapter.ViewHolder holder, int position) {
        // Get the data model based on position
        RememberAndRepeatGameType game_type = mgameActivities.get(position);
    ...
    private List<RememberAndRepeatGameType> mgameActivities;

    // Pass in the contact array into the constructor
    public RememberAndChooseAdapter(List<RememberAndRepeatGameType> gameActivities) {
